 ...
 * Modifications:-
 * $Log: hwregs.c,v $
 * Revision 1.5  1997/04/10  19:59:45  mjg
 * Removed HWScheduleScreenSwap.
 *
 * Revision 1.4  1996/11/04  15:59:10  erf
 * Add dummy routines HWSetXClip() and TexParamSize definition.
 *
 * Revision 1.3  1996/10/09  17:45:11  jop
...
*
******************************************************************************/
void HWSetXClip( sgl_bool  bClipLeft,
				 int  nLeft,
				 sgl_bool bClipRight,
				 int  nRight )
{
