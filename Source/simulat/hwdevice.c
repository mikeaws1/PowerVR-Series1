 ...
 * Modifications:-
 * $Log: hwdevice.c,v $
 * Revision 1.13  1997/03/31  22:13:16  jop
 * Got rid of windows references
 *
 * Revision 1.12  1996/12/11  01:24:34  jop
...
int	HWCreateDevice( int *device_number, int *x_dimension, int *y_dimension,sgl_device_colour_types *device_mode, sgl_bool *double_buffer)
{
