 ...
 * RCS info:
 *
 * $Date: 1997/07/14 15:07:24 $
 * $Revision: 1.5 $
 * $Locker:  $
 * $Log: heap.c,v $
 * Revision 1.5  1997/07/14  15:07:24  gdc
 * made printf's DPF's
 *
 * Revision 1.4  1997/07/14  14:48:51  gdc
 * removed ^M's
 *
 * Revision 1.3  1997/06/23  15:56:50  gdc
 * ... and another
 *
 * Revision 1.2  1997/06/23  15:55:29  gdc
 * #if 0'd a message cause there was a lot of them
 *
 * Revision 1.1  1997/06/02  02:41:46  jop
 * Initial revision
 *
 *
 *;--
...
int MemInit(void) {
    if (g_hDDHAL_DriverHeap == NULL) {
        g_hDDHAL_DriverHeap = HeapCreate(HEAP_SHARED, 0x2000, 0);
        if (g_hDDHAL_DriverHeap == NULL) {
            return FALSE;
        }
    }
