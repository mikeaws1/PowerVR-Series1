 ...
 * Modifications:-
 * $Log: hwsabsim.h,v $
 * Revision 1.1  1996/11/14  14:13:57  erf
 * Initial revision
 *
 * Revision 1.1  1996/11/14  12:34:04  erf
 * Initial revision
 *
 * Revision 1.1  1995/12/18  14:22:21  sjf
 * Initial revision
 *
...
extern	cell_control ExpandInstruction(int instr,
									BOOL do_nop,
									BOOL sec_object,
									BOOL do_flush);
